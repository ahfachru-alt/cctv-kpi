		...
		<div class="min-h-screen flex bg-gray-100 dark:bg-gray-900">
			...
			<aside class="w-72 bg-white/95 dark:bg-gray-800/95 backdrop-blur border-r border-gray-200 dark:border-gray-700 hidden md:flex md:flex-col">
				...
				<nav class="p-4 space-y-2 overflow-y-auto">
					...
					<a class="block px-3 py-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700" href="#">Location List</a>
					<a class="block px-3 py-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700" href="#">Create Location</a>
					<div class="text-xs uppercase tracking-wide text-gray-500 mt-4">Contact</div>
					<a class="block px-3 py-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700" href="#">Contact List</a>
					<a class="block px-3 py-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700" href="#">Create Contact</a>

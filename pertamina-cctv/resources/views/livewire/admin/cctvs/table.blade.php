			...
			<tr class="border-t border-gray-200 dark:border-gray-700">
				...
				<td class="px-3 py-2 text-right flex gap-2 justify-end">
					...
					<button type="button" @click="delId={{ $c->id }}" class="inline-flex items-center gap-1 px-2 py-1 rounded bg-red-600 text-white">
						<svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M6 7.5h12M9 7.5v9m6-9v9M4.5 7.5l1.5 12a2.25 2.25 0 002.24 2h7.48a2.25 2.25 0 0 0 2.24-2l1.5-12M9.75 7.5l.75-3.75h3l.75 3.75"/></svg>
						<span>Delete</span>
					</button>
				</td>
			</tr>

<div class="p-4" x-data="{ delId: null }">
	<div class="flex items-center justify-between mb-3">
		...
		<a href="{{ route('admin.users.create') }}" class="inline-flex items-center px-3 py-2 rounded-md font-medium text-white bg-indigo-600 hover:bg-indigo-700">Create User</a>
	</div>
		...
		<tbody>
			...
			<tr class="border-t border-gray-200 dark:border-gray-700">
				...
				<td class="px-3 py-2 text-right flex gap-2 justify-end">
					...
					<button type="button" @click="delId={{ $u->id }}" class="px-2 py-1 rounded bg-red-600 text-white">Delete</button>
				</td>
			</tr>
			@endforeach
		</tbody>
